...
$('#alert-coins').on('click', function(){ alert('Total Number of Coins');});
$('#alert-viziers').on('click', function(){ alert('Total Number of Viziers (yellow meeples)');});
$('#alert-artisans').on('click', function(){ alert('Total Number of Artisans (purple meeples)');});
$('#alert-elders').on('click', function(){ alert('Total Number of Elders (white meeples)');});
$('#alert-djinns').on('click', function(){ alert('Add Special Djinns and Total Points');});
$('#alert-tiles').on('click', function(){ alert('Total Victory Points on Tiles with a Camel or Tent');});
$('#alert-oasis').on('click', function(){ alert('Total Number of Oasis (trees)');});
$('#alert-villages').on('click', function(){ alert('Total Number of Villages (castles)');});
$('#alert-preciousitems').on('click', function(){ alert('Add Precious Items');});
$('#alert-merchandise').on('click', function(){ alert('Add Total Quantity for each item.');});
